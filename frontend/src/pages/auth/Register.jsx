...
export default function Register() {
  ...
  const viewKey = success ? "success" : step;
          ...
          {viewKey === "success" && (
            <motion.div key="success" variants={slideVariants} initial="hidden" animate="show" exit="exit" className="text-center">
              <motion.div
                ...
                className="w-20 h-20 mx-auto mb-6 rounded-full border-2 border-dashed border-amber flex items-center justify-center text-amber"
              >
            ...
            <motion.div key="choose" variants={slideVariants} initial="hidden" animate="show" exit="exit" className="w-full max-w-lg">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <motion.button
                  ...
                  className="text-left ticket p-6 hover:border-rust transition-colors group"
                >
                ...
                <motion.button
                  ...
                  className="text-left ticket p-6 hover:border-amber transition-colors group"
                >
